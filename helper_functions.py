...
def get_quotes(time_frame, year = 2010, month = 1, day = 1, asset = "EURUSD"):    
...
def model_bias(predicted_returns):
    ...
    if bearish_forecasts == 0:  # avoid division by zero
        return float("inf") if bullish_forecasts > 0 else 0.0
